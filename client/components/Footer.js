...
const Footer = () => {
  ...
  return (
    <div className='relative mt-64 bg-deep-purple-accent-400 bg-[#CD7F32]'>
      {' '}
      {/* A div container with background color and CSS classes */}
      <svg
        className='absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-[#CD7F32] -z-1' // An SVG element with CSS classes and styles
      ...
      <div className='px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8'>
        ...
        <div className='flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row'>
          ...
          <p className='text-sm text-gray-100 text-center'>
            ...
            AgroStake Inc. All rights reserved.
          </p>
